...
class Metadata:
    ...
    fake_segments: List[List[int]]
    audio_fake_segments: List[List[int]]
    visual_fake_segments: List[List[int]]
    video_frames: int
    audio_frames: int
...
class AVDF1M(Dataset):
    ...
    def __getitem__(self, index: int) -> List[Tensor]:
        ...
        video, audio, _ = read_video(os.path.join(self.root, meta.split, meta.file))
...
if __name__ == '__main__':
    ...
    dataset = AVDF1M(
            "train",
            root='/home/zoloz/8T-2/zhanyi/data/AV-Deepfake1M/unzip',
            frame_padding=512,
